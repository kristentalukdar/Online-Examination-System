...
public interface UserService { 
	...
	User validateAdminUser(String RegNo, String Password);
	
	User validateTeacherUser(String RegNo, String Password);
	
	User validateStudentUser(String RegNo, String Password);
}
